/**
 * @insightbazi/five-elements-colors
 * Traditional Chinese Five Elements (Wu Xing / 五行) color palette.
 *
 * In Chinese metaphysics, each of the five elements corresponds
 * to a specific color (五色):
 *
 *   Wood  (木) → 🌿 Cyan/Green  (青)
 *   Fire  (火) → 🔥 Red         (赤)
 *   Earth (土) → 🟡 Yellow      (黃)
 *   Metal (金) → ⚪ White/Gold  (白)
 *   Water (水) → 🔵 Blue/Black  (黑)
 *
 * @see https://www.insightbazi.com/en/bazi-calculator
 */
